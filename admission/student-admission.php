...
//image srt
    ...
    if (mysqli_query($conn, $insert)) {
        ...
        $create_account = "INSERT INTO `student_login_info`(`username`, `password`, `AuthID`) VALUES ('$fName','$nepaliDOB','0')";
