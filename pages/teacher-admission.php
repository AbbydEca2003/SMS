...
<head>
    ...
    <title>शिक्षक दर्ता SMS</title>
</head>
<body>
    <div class="container mt-2 shadow-sm p-3 mb-5 bg-body-tertiary rounded">
        <form action="../admission/teacher-admission.php" method="post" name="teacher-admission" id="teacher-admission" enctype="multipart/form-data">
            <div class="h4" id="error">*कृपया सबै विवरणहरू राम्ररी भर्नुहोस् Please fill out all details properly</div>
            <div class="row">
                <h1 class="h2">शिक्षक दर्ता (Teacher Registration)</h1>
                <div class="col">
                     <!-- Name in english -->
               <div class="row">
                <div class="col">
               ...
               <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <label for="nepali-datepicker">जन्म मिgit ति(BS):</label><br>
    ...
    <script src="../admission/teacher-admission.js"></script>
</body>
</html>